...
const IdeaSpark: React.FC = () => {
    ...
    const handleGenerateIdeas = async () => {
        ...
        setTimeout(() => {
            const mockIdeas = [
                `Launch a "Behind the Scenes" video series for your ${businessType}.`,
                `Run a social media contest giving away a free product/service from your ${businessType}.`,
                `Collaborate with a local influencer to review your ${businessType}.`
            ];
            setIdeas(mockIdeas);
            setIsLoading(false);
        }, 1000);
